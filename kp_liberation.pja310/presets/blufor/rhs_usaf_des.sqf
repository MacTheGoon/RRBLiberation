...
light_vehicles = [
    ["B_Quadbike_01_F",0,0,0],                                          // Quad Bike CUP_B_M1030_USMC
    ["NDS_6x6_ATV_MIL2_LR",0,0,0],                                      // 6x6
    ["CUP_B_M1030_USMC",0,0,0],                                         // Dirt Bike dbo_horse_dark
    ["dbo_horse_dark",0,0,0],                                           // Horse
    ["CUP_B_HMMWV_SOV_M2_USA",75,0,25],                                 // SOV M2
    ["CUP_B_HMMWV_SOV_USA",75,0,25],                                    // SOV Mk19
...
air_vehicles = [
    ...
    ["USAF_MQ9",400,300,200],                                           // MQ-9 USAF
    ["CUP_B_USMC_DYN_MQ9",450,500,250],                                 // MQ-9 USMC
